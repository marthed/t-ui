    ...
    if (confirmType === "device") {
      return (
        <div className="confirmLogin">
          ...
          <button
            onClick={confirmLogin({ type: confirmType })}
    ...
    return (
      <div className="confirmLogin">
        ...
        <input
          type="date"
          name="bday"
          onChange={date => this.setState({ confirmValue: date })}
        />
        <button
          onClick={confirmLogin({ type: confirmType, value: confirmValue })}
          disabled={isLoggingIn}
        >
          Fortsätt
        </button>
    ...
    return (
      <div className="login-wrapper">
        <div className="login">
          ...
          />
          <button onClick={this.onConfirm} disabled={isLoggingIn}>
            {isLoggingIn ? 'Loggar in...' : 'Logga in'}
          </button>
          {missingInput && (
            <span className="login__missing-input">
              {" "}
              {`Fyll i ${missingInput}`}
            </span>
          )}
